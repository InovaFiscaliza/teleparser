...
DTYPES = {'CallDataRecord': 'category', 
                          'CallModule': 'category', 
                          ...
                          'timeForStopOfCharge': 'category', 'outputType': 'category', 'switchIdentity': dtype('int64'), 'calledSubscriberIMSI.mcc': 'int64', 'calledSubscriberIMSI.mnc': 'int64', 'calledSubscriberIMSI.msin': 'int64', 'calledSubscriberIMSI.nome': 'category', 'calledSubscriberIMSI.cnpj': 'int64', 'calledSubscriberIMSI.pais': 'category', 'firstCalledLocationInformation.nome': 'int64', 'firstCalledLocationInformation.cnpj': 'int64', 'firstCalledLocationInformation.mnc': 'int64', 'firstCalledLocationInformation.mcc': 'int64', 'firstCalledLocationInformation.pais': 'category', 'firstCalledLocationInformation.lac': 'int64', 'firstCalledLocationInformation.ci_sac': 'int64', 'calledSubscriberIMEI.TAC': 'int64', 'calledSubscriberIMEI.SNR': 'category', 'calledSubscriberIMEI.Spare': 'int64', 'timeForTCSeizureCalled': 'category', 'mobileStationRoamingNumber.ton': 'category', 'mobileStationRoamingNumber.npi': 'category', 'mobileStationRoamingNumber.digits': 'category', 'eosInfo': 'category', 'teleServiceCode': 'category', 'mSCIdentification.ton': 'category', 'mSCIdentification.npi': 'category', 'mSCIdentification.digits': 'int64', 'gSMCallReferenceNumber': 'int64', 'mSCAddress.ton': 'category', 'mSCAddress.npi': 'category', 'mSCAddress.digits': 'int64', 'outgoingRoute': 'category', 'calledPartyNumber.ton': 'category', 'calledPartyNumber.npi': 'category', 'calledPartyNumber.digits': 'category', 'guaranteedBitRate': 'category', 'trafficClass': 'category', 'maxBitRateDownlink': 'category', 'maxBitRateUplink': 'category', 'transferDelay': 'int64', 'deliveryOfErroneousSDU1': 'category', 'deliveryOfErroneousSDU2': 'category', 'sDUErrorRatio1': 'int64', 'residualBitErrorRatio1': 'int64', 'sDUErrorRatio2': 'int64', 'residualBitErrorRatio2': 'int64', 'deliveryOfErroneousSDU3': 'category', 'sDUErrorRatio3': 'int64', 'residualBitErrorRatio3': 'int64', 'networkCallReference': 'category', 'callingPartyNumber.ton': 'category', 'callingPartyNumber.npi': 'category', 'callingPartyNumber.digits': 'int64', 'incomingRoute': 'category', 'presentationAndScreeningIndicator.screening': 'category', 'presentationAndScreeningIndicator.presentation': 'category', 'redirectionCounter': 'int64', 'relatedCallNumber': 'int64', 'callIdentificationNumber': dtype('int64'), 'typeOfCallingSubscriber': 'int64', 'tAC': 'category', 'subscriptionType': 'int64', 'originForCharging': 'int64', 'chargedParty': 'category', 'timeFromRegisterSeizureToStartOfCharging': 'category', 'internalCauseAndLoc.location': 'int64', 'internalCauseAndLoc.cause': 'int64', 'faultCode': 'int64', 'lastCalledLocationInformation.nome': 'int64', 'lastCalledLocationInformation.cnpj': 'int64', 'lastCalledLocationInformation.mnc': 'int64', 'lastCalledLocationInformation.mcc': 'int64', 'lastCalledLocationInformation.pais': 'category', 'lastCalledLocationInformation.lac': 'int64', 'lastCalledLocationInformation.ci_sac': 'int64', 'outgoingAssignedRoute': 'category', 'eMLPPPriorityLevel': 'category', 'disconnectingParty': 'category', 'originalCalledNumber.ton': 'category', 'originalCalledNumber.npi': 'category', 'originalCalledNumber.digits': 'int64', 'redirectingNumber.ton': 'category', 'redirectingNumber.npi': 'category', 'redirectingNumber.digits': 'int64', 'callingSubscriberIMSI.mcc': 'int64', 'callingSubscriberIMSI.mnc': 'int64', 'callingSubscriberIMSI.msin': 'int64', 'callingSubscriberIMSI.nome': 'category', 'callingSubscriberIMSI.cnpj': 'int64', 'callingSubscriberIMSI.pais': 'category', 'firstCallingLocationInformation.nome': 'int64', 'firstCallingLocationInformation.cnpj': 'int64', 'firstCallingLocationInformation.mnc': 'int64', 'firstCallingLocationInformation.mcc': 'int64', 'firstCallingLocationInformation.pais': 'category', 'firstCallingLocationInformation.lac': 'int64', 'firstCallingLocationInformation.ci_sac': 'int64', 'callingSubscriberIMEI.TAC': 'int64', 'callingSubscriberIMEI.SNR': 'category', 'callingSubscriberIMEI.Spare': 'int64', 'serviceCentreAddress.ton': 'category', 'serviceCentreAddress.npi': 'category', 'serviceCentreAddress.digits': 'int64', 'messageTypeIndicator': 'category', 'destinationAddress': 'category', 'camelTDPData': 'category', 'serviceKey': 'int64', 'gsmSCFAddress.ton': 'category', 'gsmSCFAddress.npi': 'category', 'gsmSCFAddress.digits': 'int64', 'sMSReferenceNumber': 'category', 'numberOfShortMessages': 'int64', 'originatingAddress': 'category', 'translatedNumber.ton': 'category', 'translatedNumber.npi': 'category', 'translatedNumber.digits': 'category', 'originatingLineInformation': 'category', 'originatedCode': 'category', 'chargeNumber.ton': 'category', 'chargeNumber.npi': 'category', 'chargeNumber.digits': 'int64', 'sMSResult': 'category', 'iNMarkingOfMS': 'category', 'timeForTCSeizureCalling': 'category', 'chargingCase': 'int64', 'lastCallingLocationInformation.nome': 'int64', 'lastCallingLocationInformation.cnpj': 'int64', 'lastCallingLocationInformation.mnc': 'int64', 'lastCallingLocationInformation.mcc': 'int64', 'lastCallingLocationInformation.pais': 'category', 'lastCallingLocationInformation.lac': 'int64', 'lastCallingLocationInformation.ci_sac': 'int64', 'incomingAssignedRoute': 'category', 'iNServiceTrigger': 'int64', 'sSFChargingCase': 'int64', 'triggerData': 'category', 'triggerDetectionPoint': 'category', 'sCPAddress.globalTitleAndSubSystemNumber.subsystem_number': 'int64', 'sCPAddress.globalTitleAndSubSystemNumber.translation_type': 'int64', 'sCPAddress.globalTitleAndSubSystemNumber.numbering_plan': 'category', 'sCPAddress.globalTitleAndSubSystemNumber.odd': 'category', 'sCPAddress.globalTitleAndSubSystemNumber.nature_of_address': 'category', 'sCPAddress.globalTitleAndSubSystemNumber.digits': 'category', 'optimalRoutingType': 'category', 'redirectingIMSI.mcc': 'int64', 'redirectingIMSI.mnc': 'int64', 'redirectingIMSI.msin': 'int64', 'redirectingIMSI.nome': 'category', 'redirectingIMSI.cnpj': 'int64', 'redirectingIMSI.pais': 'category', 'multimediaInformation': 'category', 'uILayer1Protocol': 'category', 'frequencyBandSupported.pgsm': 'category', 'frequencyBandSupported.egsm': 'category', 'frequencyBandSupported.gsm1800': 'category', 'firstRadioChannelUsed': 'category', 'firstAssignedSpeechCoderVersion': 'category', 'speechCoderPreferenceList': 'int64', 'radioChannelProperty': 'category', 'timeForEvent': 'category', 'sSCode': 'category', 'sSRequest': 'category', 'defaultCallHandling': 'category', 'cAMELDestinationAddress': 'category', 'rANAPCauseCode': 'int64', 'originatingLocationNumber.ton': 'int64', 'originatingLocationNumber.npi': 'int64', 'originatingLocationNumber.digits': 'int64', 'defaultSMSHandling': 'int64', 'bSSMAPCauseCode.cause_value': 'int64', 'freeFormatData': 'int64', 'sSFLegID': 'int64', 'bearerServiceCode': 'int64', 'fNURRequested': 'int64', 'transparencyIndicator': 'int64', 'partialOutputRecNum': 'int64'}
